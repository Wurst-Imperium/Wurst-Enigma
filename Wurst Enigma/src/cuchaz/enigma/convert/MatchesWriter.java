...
public class MatchesWriter
{
	...
	public static <T extends Entry> void writeMembers(MemberMatches<T> matches,
	...
	private static <T extends Entry> void writeMemberMatch(FileWriter out,
		T source, T dest) throws IOException
	{
		if(source != null)
