...
public class FieldMatches
{
	...
	{
		boolean wasAdded =
			m_unmatchableSourceFields.put(sourceField.getClassEntry(),
				sourceField);
		assert wasAdded;
	}
	...
	public boolean hasDest(FieldEntry fieldEntry)
	{
		return m_matches.containsValue(fieldEntry)
			|| m_unmatchedDestFields.containsValue(fieldEntry);
	}
	...
	{
		boolean wasRemoved =
			m_unmatchedSourceFields.remove(sourceField.getClassEntry(),
				sourceField);
		assert wasRemoved;
		wasRemoved =
	...
	public void unmakeMatch(FieldEntry sourceField, FieldEntry destField)
	{
		...
		assert wasRemoved;
		wasRemoved =
			m_matchedSourceFields.remove(sourceField.getClassEntry(),
				sourceField);
		assert wasRemoved;
