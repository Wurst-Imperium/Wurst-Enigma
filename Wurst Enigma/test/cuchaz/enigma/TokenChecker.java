...
public class TokenChecker
{
	...
	protected String getDeclarationToken(Entry entry)
	{
		...
		CompilationUnit tree =
			m_deobfuscator.getSourceTree(entry.getClassName());
		// DEBUG
		// tree.acceptVisitor( new TreeDumpVisitor( new File( "tree." +
		...
		EntryReference<? extends Entry, ? extends Entry> reference)
	{
		...
		for(Token token : index
			.getReferenceTokens((EntryReference<Entry, Entry>)reference))
