...
public class TestSignature
{
	...
	{
		{
			...
			assertThat(sig.getArgumentTypes(), contains(new Type("I")));
			assertThat(sig.getReturnType(), is(new Type("V")));
		}
		{
		...
		}
		{
			...
			assertThat(
				...
				contains(new Type("I"), new Type("B"), new Type("C"), new Type(
					"J")));
	...
	public void classes()
	{
		...
		}
		{
			...
			assertThat(sig.getArgumentTypes(), contains(new Type("LFoo;")));
		...
		}
		{
			...
			assertThat(
				sig.getArgumentTypes(),
				contains(new Type("LFoo;"), new Type("LMoo;"),
					new Type("LZoo;")));
			assertThat(sig.getReturnType(), is(new Type("LBar;")));
		}
	}
	...
	public void arrays()
	{
		...
		}
		{
			...
			assertThat(sig.getArgumentTypes(),
				contains(new Type("[I"), new Type("[Z"), new Type("[F")));
	...
	{
		{
			...
			assertThat(sig.getArgumentTypes(),
				contains(new Type("I"), new Type("[J"), new Type("LFoo;")));
			assertThat(sig.getReturnType(), is(new Type("Z")));
		}
		{
			final Signature sig = new Signature("(III)[LFoo;");
			assertThat(sig.getArgumentTypes(),
				contains(new Type("I"), new Type("I"), new Type("I")));
	...
	public void replaceClasses()
	{
		...
		}
		{
			...
			assertThat(sig.getArgumentTypes(),
				contains(new Type("LBar;"), new Type("LBar;")));
		...
		}
		{
			...
			assertThat(sig.getArgumentTypes(),
				contains(new Type("LFoo;"), new Type("LBar;")));
	...
	public void equals()
	{
		...
		assertThat(new Signature("(LFoo;LBar;)V"), is(new Signature(
			"(LFoo;LBar;)V")));
		assertThat(new Signature("([I)V"), is(new Signature("([I)V")));
		...
		assertThat(new Signature("([[Z)V"),
			is(not(new Signature("([[LFoo;)V"))));
	...
	public void testToString()
	{
		...
		assertThat(new Signature("(LFoo;LBar;)V").toString(),
			is("(LFoo;LBar;)V"));
		assertThat(new Signature("([I)V").toString(), is("([I)V"));
