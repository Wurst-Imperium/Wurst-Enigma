...
public class TestTokensConstructors extends TokenChecker
{
	...
	{
		assertThat(getDeclarationToken(newConstructor("none/a", "()V")),
			is("a"));
	...
	{
		assertThat(getDeclarationToken(newConstructor("none/d", "()V")),
			is("d"));
		assertThat(getDeclarationToken(newConstructor("none/d", "(I)V")),
			is("d"));
		assertThat(getDeclarationToken(newConstructor("none/d", "(II)V")),
			is("d"));
	...
	public void subIntReferences()
	{
		...
		assertThat(
			getReferenceTokens(newBehaviorReferenceByMethod(source, "none/b",
				"d", "()V")), containsInAnyOrder("d"));
		assertThat(
			getReferenceTokens(newBehaviorReferenceByConstructor(source,
				"none/d", "(II)V")), containsInAnyOrder("this"));
		assertThat(
			getReferenceTokens(newBehaviorReferenceByConstructor(source,
