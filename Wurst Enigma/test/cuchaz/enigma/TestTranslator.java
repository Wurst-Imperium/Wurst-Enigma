...
public class TestTranslator
{
	...
	{
		m_deobfuscator =
			new Deobfuscator(new JarFile("build/testTranslation.obf.jar"));
		try(InputStream in =
			TestTranslator.class
				.getResourceAsStream("/cuchaz/enigma/resources/translation.mappings"))
		{
	...
	{
		assertMapping(newField("none/a", "a", "I"),
			newField("deobf/A_Basic", "f1", "I"));
		assertMapping(newField("none/a", "a", "F"),
			newField("deobf/A_Basic", "f2", "F"));
	...
	{
		assertMapping(newMethod("none/a", "a", "()V"),
			newMethod("deobf/A_Basic", "m1", "()V"));
		assertMapping(newMethod("none/a", "a", "()I"),
			newMethod("deobf/A_Basic", "m2", "()I"));
		assertMapping(newMethod("none/a", "a", "(I)V"),
			newMethod("deobf/A_Basic", "m3", "(I)V"));
	...
	{
		assertMapping(newField("none/b", "a", "I"),
			newField("deobf/B_BaseClass", "f1", "I"));
		assertMapping(newField("none/b", "a", "C"),
			newField("deobf/B_BaseClass", "f2", "C"));
		assertMapping(newField("none/c", "b", "I"),
			newField("deobf/C_SubClass", "f3", "I"));
	...
	{
		assertMapping(newField("none/c", "a", "I"),
	...
	{
		assertMapping(newMethod("none/b", "a", "()I"),
			newMethod("deobf/B_BaseClass", "m1", "()I"));
		assertMapping(newMethod("none/b", "b", "()I"),
			newMethod("deobf/B_BaseClass", "m2", "()I"));
	...
	public void innerClasses()
	{
		...
		assertMapping(newClass("none/g$a"),
			newClass("deobf/G_OuterClass$A_InnerClass"));
		assertMapping(newClass("none/g$a$a"),
			newClass("deobf/G_OuterClass$A_InnerClass$A_InnerInnerClass"));
		...
		assertMapping(
			newField("none/g$a", "a", "Ljava/lang/String;"),
			newField("deobf/G_OuterClass$A_InnerClass", "f2",
				"Ljava/lang/String;"));
		assertMapping(
			newField("none/g$a$a", "a", "I"),
			newField("deobf/G_OuterClass$A_InnerClass$A_InnerInnerClass", "f3",
				"I"));
	...
	public void testGenerics()
	{
		...
		assertMapping(newField("none/i", "b", "Ljava/util/List;"),
			newField("deobf/I_Generics", "f2", "Ljava/util/List;"));
		assertMapping(newField("none/i", "a", "Ljava/util/Map;"),
			newField("deobf/I_Generics", "f3", "Ljava/util/Map;"));
		assertMapping(newField("none/i$b", "a", "Ljava/lang/Object;"),
			newField("deobf/I_Generics$B_Generic", "f4", "Ljava/lang/Object;"));
		assertMapping(newField("none/i", "a", "Lnone/i$b;"),
