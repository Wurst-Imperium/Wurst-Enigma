...
public class TestInnerClasses
{
	...
	private static final ClassEntry AnonymousWithScopeArgsOuter =
		newClass("none/b");
	private static final ClassEntry AnonymousWithScopeArgsInner =
		newClass("none/b$1");
	private static final ClassEntry AnonymousWithOuterAccessOuter =
		newClass("none/e");
	private static final ClassEntry AnonymousWithOuterAccessInner =
		newClass("none/e$1");
	...
	public void simple()
	{
		...
		assertThat(m_index.getInnerClasses(SimpleOuter),
			containsInAnyOrder(SimpleInner));
	...
	public void anonymous()
	{
		...
		assertThat(m_index.getInnerClasses(AnonymousOuter),
			containsInAnyOrder(AnonymousInner));
	...
	{
		assertThat(m_index.getOuterClass(ConstructorArgsInner),
			is(ConstructorArgsOuter));
		assertThat(m_index.getInnerClasses(ConstructorArgsOuter),
			containsInAnyOrder(ConstructorArgsInner));
	...
	{
		assertThat(m_index.getOuterClass(AnonymousWithScopeArgsInner),
			is(AnonymousWithScopeArgsOuter));
		assertThat(m_index.getInnerClasses(AnonymousWithScopeArgsOuter),
			containsInAnyOrder(AnonymousWithScopeArgsInner));
		assertThat(m_index.isAnonymousClass(AnonymousWithScopeArgsInner),
			is(true));
	...
	{
		assertThat(m_index.getOuterClass(AnonymousWithOuterAccessInner),
			is(AnonymousWithOuterAccessOuter));
		assertThat(m_index.getInnerClasses(AnonymousWithOuterAccessOuter),
			containsInAnyOrder(AnonymousWithOuterAccessInner));
		assertThat(m_index.isAnonymousClass(AnonymousWithOuterAccessInner),
			is(true));
